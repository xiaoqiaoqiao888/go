...
#set logscale y
set grid
set key box samplen 0 spacing 2
set xrange [0.5:8.5]
set xtics ("1-15" 1, "16-50" 2, "51-100" 3, "101-500" 4, "501-1000" 5, "1001-5000" 6, "5001-10000" 7, ">=10001" 8) nomirror rotate by 35 right
stats "passengers_range" using 2 nooutput
total_registers = int(STATS_sum)
stats 'passengers_toptally' using ($1*$2) nooutput
total_passengers = int(STATS_sum)
plot "passengers_range" using ($0+1):2:(sprintf("%d\n%.4f%%", $2, $3)) with labels point pt 7 lc 7 offset 0,1 font ",7" title sprintf("total registers = %11d\ntotal passengers = %d", total_registers, total_passengers),\
'' using ($0+1):2 smooth bezier notitle
...
unset xtics
set grid
set key box samplen 0 spacing 1
set xtics format " " nomirror
set style data histogram
set style histogram clustered gap 1
set style fill solid 0.4 border
stats "<head -15 passengers_toptally" using 3 nooutput
plot "<head -15 passengers_toptally" using 3:xtic(1) lt 6 notitle,\
'' using 0:3:3 with labels title sprintf("total {/Symbol \273} %.2f%%", STATS_sum) offset 0,0.5 font ",7"
...
'' using 0:1:1 with labels notitle offset 0,0.5 font ",7"
#plot "<tail -15 passengers_toptally | sort -k 1 -nr" using 1:xtic(1) lt 7 notitle
